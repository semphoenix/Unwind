 ...
 * Therefore, if view changes, have to change Symbol enum accordingly
 */
const Symbol = {
    BUG : 'fa fa-bug',
    TREE : 'fa fa-tree',
...
// don't want Symbol enum to change during runtime.
 ...
 * Therefore, to view changes, have to change Symbol enum accordingly
 */
const State = {
    CLOSED : 'card',
...
// don't want State enum to change during runtime
Object.freeze(State);


const Deck = {
    cards: [Symbol.BUG, Symbol.BUG, Symbol.TREE, Symbol.TREE, Symbol.CLOUD, Symbol.CLOUD, Symbol.FLOWER2, Symbol.FLOWER2, Symbol.FLOWERS, Symbol.FLOWERS, Symbol.HEART, Symbol.HEART, Symbol.LEAF, Symbol.LEAF, Symbol.PAW, Symbol.PAW],
    opened : [],
    matched : [],
    shuffle : (array) => {
...
class ViewChanger {
    ...
    static hideStartButton(bool) {
        ...
        if (bool === true) {
            ...
            d.innerHTML = `Congratulations, you're absolutely wonderful! <br><br> Total Time Taken: ${ScorePanel.time} <br> Star Rating: ${ScorePanel.star} <br> Total Moves: ${ScorePanel.move}  <br><br> Click to Restart`;
...
class EventListener {
    ...
    static setClickCards() {
        ...
        // call event handler when the card is closed
